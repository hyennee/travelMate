...
public class ConsultRequest implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6549020197673667657L;
	...
	public ConsultRequest(int cONSULT_REQUEST_NO, String tRAVEL_PURPOSE, int aDULT_NUM, int cHILD_NUM,
			String tRAVEL_AREA, Date tRAVEL_START_DATE, Date tRAVEL_END_DATE, int bUDGET, String eTC, String sTATUS,
			int rEQUEST_USER_NO, int cONSULT_USER_NO) {
		super();
	...
	public String toString() {
		return "ConsultRequest [CONSULT_REQUEST_NO=" + CONSULT_REQUEST_NO + ", TRAVEL_PURPOSE=" + TRAVEL_PURPOSE
