		...
		<div class="lowerPage">
			...
			<div class="table-responsive">
				<table class="table table-bordered">
					<tbody>
						<c:if test="${ not empty selectBoardDetail }">
							<tr>
								<td colspan="2" style="background-color: lightgray;"><h4
										style="color: orangered;">
										<b>${ selectBoardDetail.title }</b>
									</h4> 게시물번호: <b>${ selectBoardDetail.board_no }</b>&nbsp;&nbsp;|&nbsp; 등록자: <b>${ selectBoardDetail.nick_Name }(${ selectBoardDetail.user_Name })</b>&nbsp;&nbsp;|&nbsp;등록일:
