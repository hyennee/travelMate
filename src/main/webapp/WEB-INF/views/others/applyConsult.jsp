...
<link rel="stylesheet" href="/travelMate/resources/css/bootstrap.min.css" type="text/css">
<style>
.outer {
	width: 960px;
	margin: auto;
...
<body>
	...
	<div class="row">
			...
			<div class="col-sm-6 designer-text">
				...
				<br><br><br>
				트레블메이트의 여행디자이너는<br>
				자기만의 관심사와 특색을 가진 각 분야의 전문가입니다.
				<br><br>
				와인, 골프, 미술 등 여행의 테마가 될 수 있는  어떤 분야라도<br>
				경험이 풍부한 사람이라면<br>
				자신의 재능을 살려 여행을 디자인할 수 있습니다.<br>

				<br><br>
				디자인한 여행은  트레블메이트의 특색 있는 여행상품이 되어<br>
				함께 여행을 떠날 수 있는 기회를 만들고<br>
				공동의 수익 모델이  됩니다.<br>
				<br><br>
				
				<strong>이제,  여행 디자이너는 1인 브랜드입니다.</strong>
			</div>		
	...
	<div style="background-color:#f5f5f5; padding-top:30px; padding-left: 15px;">
		...
		<div class="bottombox" style="text-align:center;">
			<button id="submitPost" type="submit" class="btn btn-lg btn-squared btn-contrast" onclick="" style="background: #eb983e;">신청하기</button>
			<button id="cancel" type="reset" class="btn btn-lg btn-squared btn-contrast" style="background: #eb983e;">취소하기</button>
		</div>
</div>
</div>
	<!-- Footer -->
