		...
		<div style="width:960px; margin:auto; background:white;" align="center">
			<div style="margin:auto; width:800px;">
					...
					<div>
						...
						<c:forEach var="p" begin="${ page.startPage }" end="${ page.endPage }">
							...
							<c:if test="${ p ne page.currentPage }">
								<button type="button" class="page-button" onclick="location.href='selectList.bo?category=1&currentPage=${ p }'"><c:out value="${ p }" escapeXml="false"/></button>
							</c:if>
						</c:forEach>
				...
				<div class="search-container" style="margin:auto; width:800px;" align="center">
					<form action="selectSearch.bo?category=1" method="post">
						<div>
